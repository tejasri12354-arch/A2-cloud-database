...
def file_download():
    ...
    return render_template('download.html', my_files=my_files, shared_files=shared_files)
...
def secrets():
    ...
    return render_template('secrets.html', my_secrets=my_secrets, all_secrets=all_secrets)
